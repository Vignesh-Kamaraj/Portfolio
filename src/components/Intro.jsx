...
import na from '../assets/fy5Z.gif'
  ...
  return <>
    <section id="intro">
        <div className="introcontent">
            ...
            <span className="introtext">I'm<span className="introname" style={{backgroundImage:`url(${na})`}}>Vignesh</span><br />Full Stack Developer</span>
